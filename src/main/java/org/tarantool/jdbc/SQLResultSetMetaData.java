...
public class SQLResultSetMetaData implements TarantoolResultSetMetaData {
   ...
   * {@inheritDoc}
   * <p>
   * Always {@literal false} because Tarantool does not have monetary types.
   */
  @Override
   ...
   * {@inheritDoc}
   * <p>
   * Name always has the same value as label because Tarantool does not differentiate column names and aliases.
   *
