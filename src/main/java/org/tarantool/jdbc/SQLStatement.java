...
public class SQLStatement implements TarantoolStatement {
    ...
    public ResultSet executeQuery(String sql) throws SQLException {
        checkNotClosed();
        if (!executeInternal(NO_GENERATED_KEYS, SQLQueryHolder.of(sql))) {
    ...
    public int executeUpdate(String sql, int autoGeneratedKeys) throws SQLException {
        ...
        if (executeInternal(autoGeneratedKeys, SQLQueryHolder.of(sql))) {
    ...
    public boolean execute(String sql) throws SQLException {
        checkNotClosed();
        return executeInternal(NO_GENERATED_KEYS, SQLQueryHolder.of(sql));
    }
    ...
    public boolean execute(String sql, int autoGeneratedKeys) throws SQLException {
        checkNotClosed();
        JdbcConstants.checkGeneratedKeysConstant(autoGeneratedKeys);
        return executeInternal(autoGeneratedKeys, SQLQueryHolder.of(sql));
    }
     ...
     *                      {@code Statement}
     */
    protected boolean executeInternal(int autoGeneratedKeys, SQLQueryHolder query) throws SQLException {
        discardLastResults();
        SQLResultHolder holder;
        try {
            holder = connection.execute(timeout, query);
